...
st.slider('5000円札', 0, 10, 5, 1)
st.slider('1000円札', 0, 10, 5, 1)
st.slider('500円玉', 0, 10, 5, 1)
st.slider('100円玉', 0, 10, 5, 1)
st.slider('50円玉', 0, 10, 5, 1)
st.slider('10円玉', 0, 10, 5, 1)
st.slider('5円玉', 0, 10, 5, 1)
st.slider('1円玉', 0, 10, 5, 1)
